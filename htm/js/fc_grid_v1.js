      ...
      if(saveCodVideoGrid == ""){
        for(var i=0;i<=FC_MaxImages;i++)
        {
          if(i===0)
          {
            ...
            sHtmlZoom+="<div data-slide-id='zoom' class='zoom-gallery-slide active'><a href="+imgAmpMini+" class='MagicZoom' id='zoom2' data-mobile-options='textExpandHint:"+rk('prod-click-to-zoom-in-mobile')+";textClickZoomHint:"+rk('prod-click-to-zoom-in-pinch')+";zoomMode:off' data-options='textHoverZoomHint:"+rk('prod-click-to-zoom-in')+";textExpandHint:;selectorTrigger:hover;transitionEffect:false;lazyZoom:true'><img width='512' height='543' src="+ imgDetMini +" alt=\""+ fn.getNameProduct() +"\" "+ sLazy +"></a></div>"
