...
var sF$=(function(){
  ...
  function fnSlideshowNew(aBanners){
    ...
    var flkty = new Flickity(elemFlkty, {
      ...
      pageDots: true,
      wrapAround: true,
      autoPlay: fnGetConfig("Time_Slideshow"),
      cellAlign: 'center',
      accessibility: true,
      setGallerySize: true
    });
...
var Cart$=(function(){
  ...
  function fnShowTooltip(uurlCart){
    var oCartDesignTooltip=document.getElementById("CartDesign-header-tooltip"),
        ...
        aURL=["https://wa.me/?text="+ encodeURIComponent(rk("side-cart-shopping-look-at-this-cart")+": ") + sEncodedURL,
